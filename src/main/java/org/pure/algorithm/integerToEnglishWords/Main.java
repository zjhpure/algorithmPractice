package org.pure.algorithm.integerToEnglishWords;
...
public class Main {
    ...
    // 获取三位数的英文表示
    private static StringBuilder getEnglishStringBuilder(int rem) {
        // 定义字符串集合，保存三位数的英文表示
        StringBuilder sb = new StringBuilder();
    ...
    // 获取大于等于20的两位数的英文表示
    private static StringBuilder getTwoBitNumEnglishStringBuilder(int twoBitNum, String[] smallNums) {
        // 定义字符串集合，保存两位数的英文表示
        StringBuilder sb = new StringBuilder();
